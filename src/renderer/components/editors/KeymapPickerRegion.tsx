...
export function KeymapPickerRegion(props: KeymapPickerRegionProps): JSX.Element {
  const {
    ...
    unlocked, onLock, onUnlock, typingRecordEnabled, isDummy, toolsExtra, dataPanel, keyEditorZoom, onKeyEditorZoomChange,
        ...
        panelOverlay={
          ...
          >
            <KeycodesOverlayPanel
              ...
              unlocked={unlocked ?? false} onLock={onLock} onUnlock={onUnlock} typingRecordEnabled={typingRecordEnabled} isDummy={isDummy}
