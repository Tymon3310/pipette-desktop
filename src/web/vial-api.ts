...
export function createWebVialAPI(): VialAPI {
  ...
  return {
    ...
    i18nPackRename: async () => ({ success: true, data: undefined as never }),
    i18nPackSetEnabled: async () => ({ success: true, data: undefined as never }),
    i18nPackDelete: async () => ({ success: true }),
    i18nPackSetHubPostId: async () => ({ success: true, data: undefined as never }),
    ...
    themePackRename: async () => ({ success: true, data: undefined as never }),
    themePackDelete: async () => ({ success: true }),
    themePackSetHubPostId: async () => ({ success: true, data: undefined as never }),
